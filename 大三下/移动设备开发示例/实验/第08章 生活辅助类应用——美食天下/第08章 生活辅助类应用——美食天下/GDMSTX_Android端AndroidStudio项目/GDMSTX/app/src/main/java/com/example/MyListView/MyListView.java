...
implements	OnScrollListener 
{
	...
	public  boolean nowLoad=false;		//是否正在加载
	public boolean refreshNow=false;		//是否正在刷新
	/*
	 * author me
	 */
//	private ViewPager viewPager;
	...
	//加载图片的接口
	private OnLoadedImage onLoadImage;
	private boolean isRefreshable;
	private boolean hasRefreshable=true;
	...
	public void setResable(Boolean b)
	{
		this.hasRefreshable=b;
	}
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (!refreshNow&&!nowLoad && (firstVisibleItem + visibleItemCount >= totalItemCount)) {
			System.out.println("loade refrehs");
	...
	public boolean onTouchEvent(MotionEvent ev) {
		if (isRefreshable&&hasRefreshable) {
			switch (ev.getAction()) {
	...
	public void setOnLoadImage(OnLoadedImage onLoadImage)
	{
	...
	private void onLvRefresh() {
		if (refreshListener != null) {
			TextView tv=(TextView) this.findViewById(R.id.foot_tip);
			tv.setText("正在加载");
			refreshListener.onRefresh();
			System.out.println("onLvRefresh");
		}
	}
