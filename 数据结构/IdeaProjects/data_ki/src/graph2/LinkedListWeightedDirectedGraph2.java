...
public class LinkedListWeightedDirectedGraph2<T> implements IGraph<T> {
    ...
    public LinkedListWeightedDirectedGraph2(T[] data) {
        n = data.length;
    ...
    public static void main(String[] args) {
        ...
        LinkedListWeightedDirectedGraph2<Character> graph = new LinkedListWeightedDirectedGraph2<>(data);
